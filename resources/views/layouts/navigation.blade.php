            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif(Auth::user() && Auth::user()->user_type === 'customer')
                        ...
                        <x-nav-link :href="route('customers.orders.index')" :active="request()->is('customer/orders*')">
                            {{ __('My Orders') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @elseif(Auth::user() && Auth::user()->user_type === 'customer')
                ...
                <x-responsive-nav-link :href="route('customers.orders.index')" :active="request()->is('customer/orders*')">
                    {{ __('My Orders') }}
                </x-responsive-nav-link>
            @endif
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4 mb-2">
                <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-200 text-gray-700 font-bold mr-3">
                    {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                </span>
                <div>
                    <div class="font-semibold text-base text-gray-800">{{ Auth::user()->name }}</div>
