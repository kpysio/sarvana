...
<div class="mb-6">
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Create New Tag</h2>
            <p class="text-gray-600">Add a new tag for food items</p>
        </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select id="category" name="category" 
                        ...
                        <option value="food_type" {{ old('category') == 'food_type' ? 'selected' : '' }}>Food Type</option>
                        ...
                        <option value="food_origin" {{ old('category') == 'food_origin' ? 'selected' : '' }}>Food Origin</option>
                        <option value="dietary" {{ old('category') == 'dietary' ? 'selected' : '' }}>Dietary</option>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4" 
                              class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500"
                              placeholder="Describe what this tag represents...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="flex items-center space-x-2">
                        <div id="color-preview" class="w-4 h-4 rounded-full" style="background-color: #3B82F6;"></div>
                ...
                <div class="bg-blue-50 p-4 rounded-lg">
                    <h4 class="text-sm font-medium text-blue-700 mb-2">Category Guide</h4>
