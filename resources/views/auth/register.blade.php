    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <select id="user_type" name="user_type" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                ...
                <option value="customer" {{ old('user_type') == 'customer' ? 'selected' : '' }}>Browse and order food</option>
                <option value="provider" {{ old('user_type') == 'provider' ? 'selected' : '' }}>Sell my food</option>
            </select>
