            ...
            <div class="p-6">
                ...
                <div class="bg-orange-50 rounded-lg p-6 mb-6">
                    ...
                    @auth
                        ...
                        @endif
                    @else
                        <a href="{{ route('login', ['intended' => url('/customer/food-items/' . $foodItem->id)]) }}" class="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 rounded-md font-semibold transition inline-block">Login to order</a>
                    @endauth
                </div>
                <!-- Reviews -->
